 ...
 * @param <S>
 */
public class HHdEAConfiguration<S extends Solution> implements AlgorithmConfiguration<HHdEA> {
    ...
    @Override
    public HHdEA configure(int popSize, int maxFitnessEvaluations, Problem problem) {
